...
export const BlogSection: React.FC<BlogSectionProps> = ({
  ...
  const categories = [
    ...
    { id: 'design', label: 'تصميم الواجهات UI/UX' },
    { id: 'development', label: 'البرمجة والتطوير' },
  ...
  return (
    <div className="py-8 space-y-10">
      ...
      {featuredPost && selectedCategory === 'all' && !searchQuery && (
        <div
          onClick={() => setActivePostForModal(featuredPost)}
          ...
          <div className="relative w-full max-w-3xl bg-slate-900 border border-slate-700 rounded-3xl p-6 sm:p-10 shadow-2xl overflow-y-auto max-h-[90vh] space-y-6">
            ...
            <div className="space-y-3 pr-2">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs text-slate-400">{activePostForModal.publishedAt}</span>
