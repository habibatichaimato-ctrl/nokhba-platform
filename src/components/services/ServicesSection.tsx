...
export const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  const [budgetRange, setBudgetRange] = useState('15,000 - 30,000 ر.س');
                        ...
                        {services.map((srv) => (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <span className="text-[11px] text-amber-400 font-medium">تبدأ من {srv.startingPrice.toLocaleString()} ر.س</span>
                            </div>
                          </button>
                        ))}
                      </div>
