...
export const EcommerceSection: React.FC<EcommerceSectionProps> = ({
  ...
  const categories = [
    ...
    { id: 'accessories', label: 'ملحقات ومحطات عمل' },
    { id: 'smart-devices', label: 'أجهزة ذكية وAI' },
    { id: 'wearables', label: 'أجهزة قابلة للارتداء' },
    { id: 'hardware', label: 'عتاد وأمان سيبراني' },
    { id: 'software', label: 'برمجيات وتراخيص' },
  ];
                ...
                <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between gap-2">
                  <div>
                    <div className="flex items-baseline gap-1.5">
                      ...
                      <span className="text-xs text-amber-400 font-bold">ر.س</span>
                    </div>
                    {product.originalPrice && (
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center text-amber-400">
                    ...
                    <span className="mr-1 text-sm font-bold text-white">{selectedProductForModal.rating}</span>
                  </div>
                  <span className="text-xs text-slate-400">({selectedProductForModal.reviewsCount} تقييم موثق)</span>
                </div>
                ...
                >
                  ...
                  <span>إضافة إلى السلة ({selectedProductForModal.price * modalQuantity} ر.س)</span>
                </button>
              </div>
            </div>
          </div>
              ...
              <div className="pt-4 border-t border-slate-800 space-y-4">
                ...
                <div className="space-y-1.5 text-xs text-slate-300">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-white font-['Alexandria']">{subtotal} ر.س</span>
                  </div>
                  {discountAmount > 0 && (
                    <div className="flex justify-between text-emerald-400">
                      <span>خصم القسيمة ({discountPercent}%):</span>
                      <span className="font-bold font-['Alexandria']">-{discountAmount.toFixed(0)} ر.س</span>
                    </div>
                  )}
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between text-base font-black text-white pt-2 border-t border-slate-800">
                    ...
                    <span className="text-amber-400 font-['Alexandria']">{finalTotal.toFixed(0)} ر.س</span>
                  </div>
                </div>
            ...
            {orderCompletedId ? (
              <div className="text-center py-6 space-y-4">
                ...
                <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 text-right text-xs space-y-1.5 text-slate-300">
                  ...
                  <p><span className="text-slate-400">المبلغ الإجمالي:</span> <span className="text-amber-400 font-bold">{finalTotal.toFixed(0)} ر.س</span></p>
                </div>
                <button
                  onClick={() => {
                    setIsCheckoutModalOpen(false);
