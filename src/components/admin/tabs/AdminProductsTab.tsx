...
export const AdminProductsTab: React.FC<AdminProductsTabProps> = ({
  ...
  const [formData, setFormData] = useState<{
    ...
    inStock: true,
    featured: false,
    specsRam: '32GB Unified Memory',
    specsGpu: 'Dedicated AI NPU',
  ...
  const categories = [
    ...
    { id: 'smart-devices', label: 'أجهزة ذكية' },
    { id: 'hardware', label: 'محطات عمل وعتاد' },
    { id: 'accessories', label: 'ملحقات ومحولات' },
    { id: 'software', label: 'تراخيص وبرمجيات' },
    { id: 'wearables', label: 'أجهزة قابلة للارتداء' },
  ];
  ...
  const handleOpenAdd = () => {
    ...
    setFormData({
      ...
      featured: false,
      specsRam: '32GB RAM',
      specsGpu: 'Neural Processing Engine',
      specsStorage: '1TB SSD',
  ...
  const handleOpenEdit = (product: Product) => {
    ...
    setFormData({
      ...
      specsRam: product.specs['الذاكرة'] || '32GB',
      specsGpu: product.specs['المعالج'] || 'High Performance',
      specsStorage: product.specs['التخزين'] || '1TB',
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    const productPayload: Product = {
      ...
      specs: {
        'الذاكرة': formData.specsRam,
        'المعالج': formData.specsGpu,
        'التخزين': formData.specsStorage,
      },
                  ...
                  <tr key={product.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="p-4">
                      <div className="font-black text-slate-900 text-sm font-['Alexandria']">
                        {product.price.toLocaleString()} <span className="text-xs text-amber-600 font-bold">ر.س</span>
                      </div>
          ...
          <div className="relative w-full max-w-2xl bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={handleFormSubmit} className="p-6 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-700">السعر الحالي (ر.س) *</label>
                  <input
                    type="number"
                    required
                    min={1}
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-700">السعر الأصلي قبل الخصم (ر.س)</label>
                  <input
                    type="number"
                    min={1}
                ...
                <div className="space-y-1">
                  ...
                  >
                    <option value="smart-devices">أجهزة ذكية</option>
                    <option value="hardware">محطات عمل وعتاد</option>
                    <option value="accessories">ملحقات ومحولات</option>
                    <option value="software">تراخيص وبرمجيات</option>
                    <option value="wearables">أجهزة قابلة للارتداء</option>
                  </select>
                </div>
              </div>

              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-700">رابط صورة المنتج (Image URL) *</label>
                <input
                  type="url"
                  required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-3 bg-slate-50 rounded-2xl border border-slate-200">
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-600">مواصفة الذاكرة</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-600">المعالج / الشريحة</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-600">سعة التخزين</label>
                  <input
                    type="text"
