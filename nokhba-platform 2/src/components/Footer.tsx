      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <div className="space-y-1.5 pt-2 text-xs text-slate-500">
              <div className="flex items-center gap-2">
                ...
                <span>الرياض: طريق الملك فهد | دبي: مجمع دبي للابتكار</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 text-amber-600 shrink-0" />
                <span>contact@nexusplatform.dev</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-3.5 h-3.5 text-amber-600 shrink-0" />
                <span dir="ltr">+966 11 829 4400</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-500">
              <li>
                <button onClick={() => onNavigate('services')} className="hover:text-amber-600 transition-colors flex items-center gap-1.5">
                  <ArrowUpLeft className="w-3 h-3 text-slate-400" />
                  <span>تطوير التطبيقات والمنصات</span>
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('services')} className="hover:text-amber-600 transition-colors flex items-center gap-1.5">
                  <ArrowUpLeft className="w-3 h-3 text-slate-400" />
                  <span>حلول وأتمتة الذكاء الاصطناعي</span>
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('services')} className="hover:text-amber-600 transition-colors flex items-center gap-1.5">
              ...
              <li>
                <button onClick={() => onNavigate('careers')} className="hover:text-amber-600 transition-colors flex items-center gap-1.5 text-amber-700 font-bold">
                  ...
                  <span>وظائف مطوري البرمجيات</span>
                </button>
              </li>
              <li>
