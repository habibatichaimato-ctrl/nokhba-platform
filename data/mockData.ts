import { Product, BlogPost, JobListing } from '../types';
...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    originalPrice: 1100,
    category: 'skincare',
    categoryLabel: 'العناية بالبشرة والتجميل',
  ...
  },
  {
    ...
    categoryLabel: 'المكملات الغذائية والصحة',
  ...
  },
  {
    ...
    categoryLabel: 'المنتجات المنزلية',
  ...
  },
  {
    ...
    originalPrice: 1500,
    category: 'food',
    categoryLabel: 'الأغذية والأطعمة',
...
export const mockBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    category: 'health-nutrition-beauty',
    categoryLabel: 'التغذية والصحة والتجميل',
...
export const mockJobListings: JobListing[] = [
  {
    ...
    benefits: [
      ...
      'ميزانية سنوية مخصصة للتعلم والتطوير وحضور المؤتمرات العالمية (15,000 د.م)',
  ...
  },
  {
    ...
    typeLabel: 'دوام كامل',
    experience: '+4 سنوات خبرة',
    salaryRange: '18,000 - 25,000 د.م / شهرياً',
